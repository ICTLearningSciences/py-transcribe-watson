...
class WatsonTranscriptionService(TranscriptionService):
    def init_service(self, config: Dict[str, Any] = {}, **kwargs):
        ...
        """
        username = config.get("WATSON_USERNAME") or require_env("WATSON_USERNAME")
        password = config.get("WATSON_PASSWORD") or require_env("WATSON_PASSWORD")
...
register_transcription_service_factory("transcribe_watson", WatsonTranscriptionService)
